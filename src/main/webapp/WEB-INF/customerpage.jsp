    ...
    <body>
        <nav class="container-fluid fogNavbar navbar-default">
            ...
            <ul class="nav navbar-nav">
                ...
                <li><a href="./inputpage.jsp" class="tabNavButton">Byg Carport</a></li>
            </ul>
        </nav>
        <div class="container-fluid h100">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <h1>Hej <%= request.getParameter("username")%> </h1>
                    <h4>Klik <a href="./inputpage.jsp">her</a> for at bygge din karport.</h4>
                </div>
            </div>
        </div>
    </div>
